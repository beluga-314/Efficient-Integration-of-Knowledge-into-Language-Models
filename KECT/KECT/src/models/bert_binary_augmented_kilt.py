...
class BertBinaryAugmented(LightningModule):
    ...
    def add_model_specific_args(parent_parser):
        ...
        parser.add_argument(
            "--train_data_path",
            type=str,
            default="/home/kondamkalyanreddy/nlp-project/KnowledgeEditor/datasets/fever-train-kilt.jsonl",
        )
        parser.add_argument(
            "--dev_data_path",
            type=str,
            default="/home/kondamkalyanreddy/nlp-project/KnowledgeEditor/datasets/fever-dev-kilt.jsonl",
        )
        parser.add_argument("--model_checkpoint",type=str,default="/home/kondamkalyanreddy/nlp-project/KnowledgeEditor/models/FC_model.ckpt")
    ...
    def __init__(self, *args, **kwargs):
       ...
       #print(self.hparams)
        self.model = BertBinary.load_from_checkpoint(
            "/home/kondamkalyanreddy/nlp-project/KnowledgeEditor/models/FC_model.ckpt"
        ).model.eval()
        ...
        self.register_buffer("margin_kl", torch.tensor(1e-1))
        self.register_buffer("margin_lp", torch.tensor(1e-6))
    ...
    def val_dataloader(self, shuffle=True):
        if not hasattr(self, "val_dataset"):
            self.val_dataset = BinaryAugmentedKILT(
                tokenizer=self.tokenizer,
                data_path="/home/kondamkalyanreddy/nlp-project/KnowledgeEditor/datasets/fever-dev-kilt.jsonl",
                max_length=self.hparams.max_length,
                return_view=self.hparams.use_views,
            )
        return DataLoader(
    ...
    #     # Initialize model with args and kwargs
